...
public class DataUtility {
	...
	/*
	 * public static String dataFilePath = System.getProperty("user.dir") +
...
//	public static String dataFilePath = "C:\\TestData.xlsx";
	// public static String dataFilePath = "C:\\" + dataFile;
	  ...
	  static String env = System.getProperty("env").length() > 0 ?
	  System.getProperty("env") : "stage"; static String dataFile =
	  env.equalsIgnoreCase("prod") ? "TestDataProd.xlsx" : "TestData.xlsx"; public
	  static final String dataFilePath = System.getProperty("user.dir") +
	  File.separator + "resources" + File.separator + dataFile;
